...
//工具app首地址地址
#define SPI_FLASH_TOOL_APP_ADDEESS					0x0//工具app区

//dut的boot首地址
#define SPI_FLASH_DUT_BOOT_ADDEESS    				(SPI_FLASH_TOOL_APP_ADDEESS + 0x40000)//dut_boot区

//dut的app首地址
#define SPI_FLASH_DUT_APP_ADDEESS					(SPI_FLASH_TOOL_APP_ADDEESS + 0x60000)//dut_app区

//dut的config首地址
#define SPI_FLASH_DUT_CONFIG_ADDEESS				(SPI_FLASH_TOOL_APP_ADDEESS + 0x160000)//dut_config区
 
// BLE升级标志地址
#define SPI_FLASH_TOOL_UPDATA_FLAG_ADDEESS			(SPI_FLASH_TOOL_APP_ADDEESS + 0x161000)//other区
...
//dut的ui首地址
 #define SPI_FLASH_DUT_UI_ADDEESS					0x200000//ui区
