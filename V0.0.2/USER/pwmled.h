...
/********************************* 模块驱动层修改 ************************************/
// 软硬件PWM模式切换
#define LED_PWM_MODE							LED_SOFT_PWM				// LED功能模式
...
#define LED_ORANGE_1_PIN						GPIO_PIN_9
#define LED_ORANGE_2_PIN						GPIO_PIN_10
#define LED_ORANGE_3_PIN						GPIO_PIN_14
#define LED_ORANGE_4_PIN						GPIO_PIN_15
#define LED_ORANGE_5_PIN						GPIO_PIN_7


#define LED_BLUE_1_PIN							GPIO_PIN_0
#define LED_BLUE_2_PIN							GPIO_PIN_1
#define LED_BLUE_3_PIN							GPIO_PIN_2
#define LED_BLUE_4_PIN							GPIO_PIN_11
#define LED_BLUE_5_PIN							GPIO_PIN_12
