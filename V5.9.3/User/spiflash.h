...
// UI版本存放地址
#define SPI_FLASH_UI_VERSION_ADDEESS                (SPI_FLASH_TOOL_UPDATA_FLAG_ADDEESS + 36 * 1024)

// IOT APP升级数据长度
#define SPI_FLASH_IOT_APP_UP_DATA_LEN                (SPI_FLASH_TOOL_UPDATA_FLAG_ADDEESS + 40 * 1024)

// IOT APP CRC8
#define SPI_FLASH_IOT_CRC8                           (SPI_FLASH_TOOL_UPDATA_FLAG_ADDEESS + 44 * 1024)
