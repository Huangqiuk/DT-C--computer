...
#define UART_PROTOCOL3_CMD_HEAD						0x3A	// 命令头
#define UART_PROTOCOL3_DEVICE_ADDR						0x1A	// 设备地址
#define UART_PROTOCOL3_IOT_DEVICE_ADDR						0x2A	// IOT设备地址


#define UART_PROTOCOL3_RX_CMD_HMI_CTRL_RUN_LENGTH_MAX			8		// 该命令帧最大接收长度
#define UART_PROTOCOL3_RX_CMD_WRITE_CONTROL_PARAM_LENGTH_MAX	150		// 该命令帧最大接收长度
#define UART_PROTOCOL3_RX_CMD_READ_CONTROL_PARAM_LENGTH_MAX		4		// 该命令帧最大接收长度

#define UART_PROTOCOL3_TX_CMD_FRAME_LENGTH_MAX 		100		// 最大发送命令帧长度
#define UART_PROTOCOL3_RX_CMD_FRAME_LENGTH_MAX 		150		// 最大接收命令帧长度

#define UART_PROTOCOL3_RX_FIFO_SIZE					200		// 接收一级缓冲区大小
#define UART_PROTOCOL3_CMD_FRAME_LENGTH_MIN			8		// 命令帧最小长度，包含:起始符、异或调整值、错误信息、异或校验
...
typedef enum
{
	UART_PROTOCOL3_CMD_HEAD_INDEX = 0,					// 帧头索引
		UART_PROTOCOL3_CMD_DEVICE_ADDR_INDEX,				// 设备地址
		UART_PROTOCOL3_CMD_CMD_INDEX,						// 命令字索引
		UART_PROTOCOL3_CMD_LENGTH_INDEX, 					// 数据长度
		...
		UART_PROTOCOL3_CMD_DATA15_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA16_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA17_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA18_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA19_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA20_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA21_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA22_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA23_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA24_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA25_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA26_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA27_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA28_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA29_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA30_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA31_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA32_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA33_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA34_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA35_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA36_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA37_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA38_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA39_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA40_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA41_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA42_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA43_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA44_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA45_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA46_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA47_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA48_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA49_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA50_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA51_INDEX, 					// 数据索引
		UART_PROTOCOL3_CMD_DATA52_INDEX, 					// 数据索引
...
typedef enum{
	...
	UART_PROTOCOL3_CMD_CONFIG_SET = 0x53,			            // 参数设置
	UART_PROTOCOL3_CMD_WRITE_CONTROL_PARAM = 0xC0,				// 写控制器参数
	UART_PROTOCOL3_CMD_WRITE_CONFIG_RESULT = 0xC1,		        // 写控制器参数结果应答
	UART_PROTOCOL3_CMD_READ_CONTROL_PARAM = 0xC2,				// 读取控制器参数
	UART_PROTOCOL3_CMD_READ_CONTROL_PARAM_REPORT = 0xC3,		// 控制器参数上报
    UART_PROTOCOL3_CMD_PROTOCOL_SWITCCH = 0xAB,                 // 协议切换命令
	UART_PROTOCOL3_CMD_VERSION_TYPE_WRITE = 0xA8,			    // 写入版本信息
	UART_PROTOCOL3_CMD_VERSION_TYPE_READ = 0xA9,				// 读取版本信息 
	UART_PROTOCOL3_CMD_DCD_FLAG_WRITE = 0xA7,				    // 写入DCD标志（5）
	UART_PROTOCOL3_CMD_DCD_FLAG_READ = 0xA6,				    // 读取DCD标志（5）
 
    // iot升级
	UART_PROTOCOL3_CMD_UPDATE_REQUEST = 0xF1,		// 升级请求命令
	UART_PROTOCOL3_CMD_UPDATE_START = 0xF2,			// 升级固件命令
	UART_PROTOCOL3_CMD_WRITE_DATA = 0xF3,			// 数据包写入命令
	UART_PROTOCOL3_CMD_WRITE_COMPLETE = 0xF4,		// 数据包写入完成命令
