 ...
 *                                  宏定义	                                   *
********************************************************************************/
#define UART_DRIVE_TX_MODE						UART_DRIVE_BLOCKING_TX_MODE	// 选择阻塞发送还是中断发送数据
#define UART_DRIVE_TYPE_DEF						USART3							// 选择串口(串口中断和时钟都需要修改)
#define UART_DRIVE_IRQn_DEF						USART3_IRQn 				// 选择串口(串口中断和时钟都需要修改)

#define UART_DRIVE_BAUD_RATE					9600	// 通讯波特率

#define UART_DRIVE_TX_QUEUE_SIZE				3		// 驱动层发送命令帧尺寸
