...
//                    STATE_SwitchStep(STEP_CM_CAN_UPGRADE_ITEM_FINISH);
                STATE_SwitchStep(STEP_CM_CAN_UPGRADE_APP_UP_SUCCESS_RESET);
                break;
...
//            break;
//        default:
//            CAN_PROTOCOL1_MacProcess(rxMessage1.rx_sfid, &rxMessage1.rx_data[0], rxMessage1.rx_dlen);          // 写config
//            CAN_MacProcess(rxMessage1.rx_sfid, &rxMessage1.rx_data[0], rxMessage1.rx_dlen);                    // 55升级协议
//            CAN_TEST_MacProcess(rxMessage1.rx_sfid, &rxMessage1.rx_data[0], rxMessage1.rx_dlen);               // 测试协议
//            break;
//        }
//    }
//}
