...
#define CAN_RX_FIFO_SIZE                    140         // 接收缓冲区尺寸
#define CAN_RX_QUEUE_SIZE                   40          // 接收命令帧尺寸
#define CAN_TX_QUEUE_SIZE                   30          // 发送命令帧尺寸     

#define CAN_CMD_FRAME_LENGTH_MIN            4       // 命令帧最小长度，包括4个字节: 命令头(1Byte)+命令字(1Byte)+数据长度(1Byte)+校验码(1Byte)
#define CAN_CMD_FRAME_LENGTH_MAX            140     // 定义CAN最大的命令长度为140个字节

#define CAN_CMD_HEAD                        0x3A    // 命令头
